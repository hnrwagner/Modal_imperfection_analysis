...
def Create_Material_Data_2D(model,material_name,e11,e22,nu12,g12,g13,g23,rho):
    mdb.models[model].Material(name=material_name)
...
Create_Material_Data_2D(myString,"CFRP",myE11,myE22,myNu12,myG12,myG13,myG23,Density)
